...
let games = [
  ...
  },
  {
    ...
    description: 'Players assume the first-person perspective of a customisable mercenary known as V, who can acquire skills in hacking and machinery with options for melee and ranged combat.',
    likes: 0,
    rating: 10
  },
  {
...
<template>
  ...
  <ExploreCarousel :items="games" title="Top Rated Games"/>

  <ExploreCarousel :items="games" title="Recent Games"/>

  <ExploreCarousel :items="games" title="Popular Games"/>
